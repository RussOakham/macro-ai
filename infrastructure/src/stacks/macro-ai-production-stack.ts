...
export class MacroAiProductionStack extends cdk.Stack {
	...
	private createOutputs(): void {
		...
		new cdk.CfnOutput(this, 'AutoScalingMinCapacity', {
			value:
				this.autoScaling.scalableTaskCount.scaleToTrackCustomMetric.toString()
					? '2'
					: 'N/A',
		...
		new cdk.CfnOutput(this, 'SecurityDashboardUrl', {
			value: `https://${this.region}.console.aws.amazon.com/cloudwatch/home?region=${this.region}#dashboards:name=${this.environmentName}-security-dashboard`,
