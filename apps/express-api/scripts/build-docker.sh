...
# Docker build script for Macro AI Express API
# Usage: ./scripts/build-docker.sh [environment] [version] [push]
...
echo -e "${BLUE}🐳 Building Docker image for Macro AI Express API${NC}"
