...
export const UserProfileSchema = {
    ...
    required: ['id', 'email', 'emailVerified', 'firstName', 'lastName', 'createdAt', 'updatedAt', 'lastLogin']
} as const;
...
export const ChatMessageSchema = {
    ...
    required: ['id', 'chatId', 'role', 'content', 'metadata', 'embedding', 'createdAt']
} as const;
...
export const ChatVectorSchema = {
    ...
    required: ['id', 'userId', 'chatId', 'messageId', 'content', 'embedding', 'metadata', 'createdAt', 'updatedAt']
} as const;
...
export const SystemInfoResponseSchema = {
    ...
    required: ['nodeVersion', 'platform', 'architecture', 'uptime', 'memoryUsage', 'cpuUsage', 'timestamp'],
...
export const DetailedHealthResponseSchema = {
    ...
    required: ['status', 'message', 'timestamp', 'uptime', 'version', 'environment', 'checks'],
