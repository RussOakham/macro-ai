...
import type { PostAuthRegisterData, PostAuthRegisterResponses, PostAuthRegisterErrors, PostAuthConfirmRegistrationData, PostAuthConfirmRegistrationResponses, PostAuthConfirmRegistrationErrors, PostAuthResendConfirmationCodeData, PostAuthResendConfirmationCodeResponses, PostAuthResendConfirmationCodeErrors, PostAuthLoginData, PostAuthLoginResponses, PostAuthLoginErrors, PostAuthForgotPasswordData, PostAuthForgotPasswordResponses, PostAuthForgotPasswordErrors, PostAuthConfirmForgotPasswordData, PostAuthConfirmForgotPasswordResponses, PostAuthConfirmForgotPasswordErrors, PostAuthLogoutData, PostAuthLogoutResponses, PostAuthLogoutErrors, PostAuthRefreshData, PostAuthRefreshResponses, PostAuthRefreshErrors, GetAuthUserData, GetAuthUserResponses, GetAuthUserErrors, GetChatsData, GetChatsResponses, GetChatsErrors, PostChatsData, PostChatsResponses, PostChatsErrors, DeleteChatsByIdData, DeleteChatsByIdResponses, DeleteChatsByIdErrors, GetChatsByIdData, GetChatsByIdResponses, GetChatsByIdErrors, PutChatsByIdData, PutChatsByIdResponses, PutChatsByIdErrors, PostChatsByIdStreamData, PostChatsByIdStreamResponses, PostChatsByIdStreamErrors, GetUsersByIdData, GetUsersByIdResponses, GetUsersByIdErrors, GetUsersMeData, GetUsersMeResponses, GetUsersMeErrors, GetHealthData, GetHealthResponses, GetHealthErrors, GetSystemInfoData, GetSystemInfoResponses, GetSystemInfoErrors, GetHealthDetailedData, GetHealthDetailedResponses, GetHealthDetailedErrors, GetHealthReadyData, GetHealthReadyResponses, GetHealthReadyErrors, GetHealthReadyPublicData, GetHealthReadyPublicResponses, GetHealthReadyPublicErrors, GetHealthLiveData, GetHealthLiveResponses, GetHealthLiveErrors, GetHealthConfigData, GetHealthConfigResponses, GetHealthConfigErrors } from './types.gen';
 ...
 */
export const postAuthConfirmRegistration = <ThrowOnError extends boolean = false>(options?: Options<PostAuthConfirmRegistrationData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostAuthConfirmRegistrationResponses, PostAuthConfirmRegistrationErrors, ThrowOnError>({
        responseType: 'json',
 ...
 */
export const postAuthResendConfirmationCode = <ThrowOnError extends boolean = false>(options?: Options<PostAuthResendConfirmationCodeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostAuthResendConfirmationCodeResponses, PostAuthResendConfirmationCodeErrors, ThrowOnError>({
        responseType: 'json',
...
export const postAuthForgotPassword = <ThrowOnError extends boolean = false>(options?: Options<PostAuthForgotPasswordData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostAuthForgotPasswordResponses, PostAuthForgotPasswordErrors, ThrowOnError>({
        responseType: 'json',
 ...
 */
export const postAuthConfirmForgotPassword = <ThrowOnError extends boolean = false>(options?: Options<PostAuthConfirmForgotPasswordData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostAuthConfirmForgotPasswordResponses, PostAuthConfirmForgotPasswordErrors, ThrowOnError>({
        responseType: 'json',
...
export const getAuthUser = <ThrowOnError extends boolean = false>(options?: Options<GetAuthUserData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAuthUserResponses, GetAuthUserErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                in: 'cookie',
...
export const postChats = <ThrowOnError extends boolean = false>(options?: Options<PostChatsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostChatsResponses, PostChatsErrors, ThrowOnError>({
        responseType: 'json',
        url: '/chats',
        ...options,
        headers: {
...
export const deleteChatsById = <ThrowOnError extends boolean = false>(options: Options<DeleteChatsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteChatsByIdResponses, DeleteChatsByIdErrors, ThrowOnError>({
        responseType: 'json',
        url: '/chats/{id}',
        ...options
    });
...
export const getChatsById = <ThrowOnError extends boolean = false>(options: Options<GetChatsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetChatsByIdResponses, GetChatsByIdErrors, ThrowOnError>({
        responseType: 'json',
        url: '/chats/{id}',
        ...options
    });
...
export const putChatsById = <ThrowOnError extends boolean = false>(options: Options<PutChatsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutChatsByIdResponses, PutChatsByIdErrors, ThrowOnError>({
        responseType: 'json',
        url: '/chats/{id}',
        ...options,
        headers: {
 ...
 */
export const postChatsByIdStream = <ThrowOnError extends boolean = false>(options: Options<PostChatsByIdStreamData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostChatsByIdStreamResponses, PostChatsByIdStreamErrors, ThrowOnError>({
        responseType: 'text',
        url: '/chats/{id}/stream',
        ...options,
        headers: {
...
export const getUsersMe = <ThrowOnError extends boolean = false>(options?: Options<GetUsersMeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUsersMeResponses, GetUsersMeErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                in: 'cookie',
 ...
 */
export const getHealthDetailed = <ThrowOnError extends boolean = false>(options?: Options<GetHealthDetailedData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetHealthDetailedResponses, GetHealthDetailedErrors, ThrowOnError>({
        responseType: 'json',
        url: '/health/detailed',
        ...options
    });
 ...
 */
export const getHealthReadyPublic = <ThrowOnError extends boolean = false>(options?: Options<GetHealthReadyPublicData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetHealthReadyPublicResponses, GetHealthReadyPublicErrors, ThrowOnError>({
        responseType: 'json',
...
export const getHealthLive = <ThrowOnError extends boolean = false>(options?: Options<GetHealthLiveData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetHealthLiveResponses, GetHealthLiveErrors, ThrowOnError>({
        responseType: 'json',
        url: '/health/live',
        ...options
    });
 ...
 */
export const getHealthConfig = <ThrowOnError extends boolean = false>(options?: Options<GetHealthConfigData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetHealthConfigResponses, GetHealthConfigErrors, ThrowOnError>({
        responseType: 'json',
        url: '/health/config',
        ...options
    });
